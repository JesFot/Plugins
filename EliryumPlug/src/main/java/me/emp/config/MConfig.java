...
public class MConfig
{
	...
	public MConfig(FileConfiguration file, EliryumPlug p_emp)
	{
		this.confFile = file;
		this.emp = p_emp;
		this.varConfig = new EVarConfig(p_emp);
	}
	
	public EVarConfig getVarConfig()
	{
	...
	public void reloadCustomConfig()
	{
		...
		{
			this.customConfigFile = new File(this.emp.getPlugin().getDataFolder(), "empConfig.yml");
		}
		...
		try
		{
			defConfigStream = new InputStreamReader(this.emp.getPlugin().getResource("empConfig.yml"), "UTF8");
		}
	...
	public void saveCustomConfig()
	{
		...
		{
			this.emp.getLogger().log(Level.SEVERE, "Could not save config to " + this.customConfigFile, ex);
		}
	}
	public void saveDefaultConfig()
	{
		...
		{
			this.emp.getPlugin().saveResource("empConfig.yml", false);
		}
	}
	...
	public Location getLoc(String name)
	{
		...
		if (key == null || key == "")
		{
			this.emp.getLogger().log(Level.WARNING, "[MConfig:116] Key is null");
			return null;
		}
	...
	public Inventory getInventory(String name)
	{
		...
		{
			this.emp.getLogger().log(Level.WARNING, "[MConfig:243] KeyInv is null");
			return null;
		}
		String keycon= this.getCustomConfig().getString(name+".con");
		if (keycon == null || keycon == "")
		{
			this.emp.getLogger().log(Level.INFO, "[MConfig:249] KeyContents is null");
			invOnly = true;
		}
