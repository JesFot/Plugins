...
public class MSecurityWallSys
{
	...
	public MSecurityWallSys(MetalPonyPlug mppl)
	{
		this.mpp = mppl;
	...
	public void setY(int y)
	{
		...
		{
			this.coords.setWorld(this.mpp.getServer().getWorlds().get(0));;
		}
	}
	...
	{
		this.blocks.clear();
		for(int i = 0; i < this.mpp.getServer().getWorlds().get(0).getMaxHeight(); i++)
		{
