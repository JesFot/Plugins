...
public class InventorySerializer
{
	...
	{
		net.minecraft.server.v1_11_R1.PlayerInventory pinv = new net.minecraft.server.v1_11_R1.PlayerInventory(null);
		org.bukkit.craftbukkit.v1_11_R1.inventory.CraftInventoryPlayer inv = new org.bukkit.craftbukkit.v1_11_R1.inventory.CraftInventoryPlayer(pinv);
		return (inv);
	}
}