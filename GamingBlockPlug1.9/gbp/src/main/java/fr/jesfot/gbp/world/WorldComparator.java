...
public class WorldComparator
{
	...
	public static boolean isEqualWorld(World alpha, World beta, GamingBlockPlug_1_9 gbp)
	{
	...
	public static void setDefaultGamemode(GamingBlockPlug_1_9 gbp, String worldName, String gameMode)
	{
	...
	public static String getDefaultGamemode(GamingBlockPlug_1_9 gbp, String worldName)
	{
		NBTSubConfig world = new NBTSubConfig(gbp.getConfigFolder("worldsdatas"), worldName).readNBTFromFile();
		return world.getCopy().getString("Option.Gamemode")!=""?world.getCopy().getString("Option.Gamemode"):"NaN";
	}
	
	public static void setKeepInventory(GamingBlockPlug_1_9 gbp, String worldName, boolean value)
	{
		NBTSubConfig world = new NBTSubConfig(gbp.getConfigFolder("worldsdatas"), worldName).readNBTFromFile();
		world.setBoolean("Option.KeepInventory", value).writeNBTToFile();
	}
	
	public static boolean getKeepInventory(GamingBlockPlug_1_9 gbp, String worldName)
	{
		NBTSubConfig world = new NBTSubConfig(gbp.getConfigFolder("worldsdatas"), worldName).readNBTFromFile();
		return world.getCopy().getBoolean("Option.KeepInventory");
	}
	
	public static void setChangeBedSpawn(GamingBlockPlug_1_9 gbp, String worldName, boolean value)
	{
		NBTSubConfig world = new NBTSubConfig(gbp.getConfigFolder("worldsdatas"), worldName).readNBTFromFile();
		world.setBoolean("Option.ChangeBedSpawn", value).writeNBTToFile();
	}
	
	public static boolean getChangeBedSpawn(GamingBlockPlug_1_9 gbp, String worldName)
	{
		NBTSubConfig world = new NBTSubConfig(gbp.getConfigFolder("worldsdatas"), worldName).readNBTFromFile();
		return world.getCopy().getBoolean("Option.ChangeBedSpawn");
	}
	
	public static void setKeepLocation(GamingBlockPlug_1_9 gbp, String worldName, boolean value)
	{
		NBTSubConfig world = new NBTSubConfig(gbp.getConfigFolder("worldsdatas"), worldName).readNBTFromFile();
		world.setBoolean("Option.KeepLocation", value).writeNBTToFile();
	}
	
	public static boolean getKeepLocation(GamingBlockPlug_1_9 gbp, String worldName)
	{
		NBTSubConfig world = new NBTSubConfig(gbp.getConfigFolder("worldsdatas"), worldName).readNBTFromFile();
		return world.getCopy().getBoolean("Option.KeepLocation");
	}
	
	public static void setAutoUnload(GamingBlockPlug_1_9 gbp, String worldName, boolean value)
	{
		NBTSubConfig world = new NBTSubConfig(gbp.getConfigFolder("worldsdatas"), worldName).readNBTFromFile();
		world.setBoolean("Option.AutoUnload", value).writeNBTToFile();
	}
	
	public static boolean getAutoUnload(GamingBlockPlug_1_9 gbp, String worldName)
	{
		NBTSubConfig world = new NBTSubConfig(gbp.getConfigFolder("worldsdatas"), worldName).readNBTFromFile();
